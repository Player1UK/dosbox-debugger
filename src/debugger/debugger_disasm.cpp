...
static bool CreateDataEntry( const uint32_t address, const uint16_t segment, const uint32_t call_address, const ZydisDecodedOperand &op ) {
    bool result = false;
    ...
    if( pcallers ) {
        pcallers->insert( { call_address, segment } );
